...
public static class Const
{
    ...
    //Anim
    public static string IDLE_ANIM = "lumber_idle";
    public static string WALK_ANIM = "lumber_walk";
    public static string CHOP_ANIM = "lumber_chop";
    public static string CHAINSAWWALK_ANIM = "lumber_chainsaw walk";
